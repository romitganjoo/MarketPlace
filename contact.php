      ...
      <div class="top-bar">
        <div class="content-topbar flex-sb-m h-full container">
          ...
          <div class="right-top-bar flex-w h-full">
            ...
            <a href="contact.php" id="top_bar_logout" style="display:none;" class="flex-c-m trans-04 p-lr-25">
              Logout
            </a>
          </div>
        </div>
      ...
      <ul class="topbar-mobile">
        ...
        <li>
          <div class="right-top-bar flex-w h-full">
            ...
            <a href="contact.php" id="top_bar_logout" style="display:none;" class="flex-c-m p-lr-10 trans-04">
              Logout
            </a>
          </div>
        </li>
    ...
    <div class="container">
      <div class="flex-w flex-tr">
        <div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
          <form id="SendEmail" method="POST" action="./contact.php">
            ...
            <select class="form-control" id="sel1" name="StoreEmailAddress" required>
              ...
              <option value="Games">The Game Store</option>
              <option value="Homes">Nestaway</option>
              <option value="Bikes">The Bike Store</option>
              <option value="Books">Word The Bookstore</option>
            </select><br>
          ...
          if (isset($_POST['submit'])) {
            switch ($_POST['StoreEmailAddress']) {
              case "Homes":
                $storeAddress = "pratikbhandarkar25@gmail.com";
                break;

              case "Games":
                $storeAddress = "bhoj.vedant28@gmail.com";
                break;

              case "Bikes":
                $storeAddress = "nikhillimaye10@gmail.com";
                break;

              case "Books":
                $storeAddress = "ketan.rudrurkar@gmail.com";
                break;
            }
            ...
            $query = "INSERT INTO contacts (email, feedback) VALUES (?, ?)";
            $stmt = $conn->prepare($query);
            $stmt->bind_param("ss", $userEmailAddress, $message);
            $stmt->execute();
          }
          ...
          <div class="flex-w w-full p-b-42">
            ...
            <div class="size-212 p-t-2">
              ...
              <p class="stext-115 cl6 size-213 p-t-18">
                MarktPlatz Center 8th floor, 379 Hudson St, San Jose, CA 95667
              </p>
            </div>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-lg-3 p-b-50">
          ...
          <p class="stext-107 cl7 size-201">
            Any questions? Let us know in store at 8th floor, 379 Hudson St, San Jose, CA 95667 or call us on +1 800 1234567
          </p>
